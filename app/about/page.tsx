  ...
  return (
    <motion.div
      ...
      style={{
        ...
        cursor: "pointer",
        background: cardBg,
        border: `1px solid ${hovered ? "rgba(155,48,255,0.35)" : isLight ? "rgba(53,6,62,0.15)" : "rgba(255,255,255,0.04)"}`,
        transition: "all 0.4s cubic-bezier(0.16, 1, 0.3, 1)",
        transform: hovered ? "translateY(-8px)" : "translateY(0)",
        boxShadow: hovered
          ? "0 20px 50px rgba(155,48,255,0.15), 0 0 0 1px rgba(155,48,255,0.15)"
          : isLight ? "0 2px 8px rgba(53,6,62,0.1)" : "0 2px 8px rgba(0,0,0,0.3)",
      }}
    >
      ...
      <main style={{ background: isLight ? "#eeeaf4" : "#000000", minHeight: "100vh" }}>
        ...
        <section ref={heroRef} style={{
          ...
          >
            ...
            {isLight ? (
              <span style={{ color: "#35063e" }}>Shaping It</span>
            ) : (
              <span style={{
          ...
          <div style={{ maxWidth: "700px", margin: "0 auto" }}>
            ...
            >
              ...
              <h2 style={{
                ...
                <span style={{ color: "transparent", WebkitTextStroke: isLight ? "1.5px rgba(53,6,62,0.6)" : "1.5px rgba(155,48,255,0.5)" }}>Connect</span>
              </h2>
            </motion.div>
              ...
              {[
                ...
                <motion.a
                  ...
                  style={{
                    ...
                    padding: "24px 12px",
                    borderRadius: "16px",
                    background: isLight ? "rgba(53,6,62,0.06)" : "rgba(255,255,255,0.015)",
                    border: isLight ? "1px solid rgba(53,6,62,0.12)" : "1px solid rgba(155,48,255,0.06)",
